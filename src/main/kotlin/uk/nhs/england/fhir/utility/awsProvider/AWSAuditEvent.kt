package uk.nhs.england.fhir.utility.awsProvider
...
import uk.nhs.england.fhir.utility.configuration.MessageProperties
...
class AWSAuditEvent(@Qualifier("R4") val ctx: FhirContext,
    ...
    fun createAudit(resource : Resource, auditEventAction: AuditEvent.AuditEventAction?): AuditEvent {
        ...
        entityComponent.type = Coding().setSystem(uk.nhs.england.fhir.utility.util.FhirSystems.FHIR_RESOURCE_TYPE).setCode("Patient")
